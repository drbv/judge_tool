...
Judge-Toll functionality and Porcess in words:
...
Grober Porcess Ablauf:
1.) Eine komplette Runde wird aus dem Turnierprogramm importiert. 
2.) Alle Tanzrunden der Runde werden durchgeführt. Während der Durchführung einer Tanzrunde werden die Paare durch den Wertungsrichter und den Observer be
2.) Nach Ende der Runde werden Werte zurück in das Turnierprogramm geschrieben.
